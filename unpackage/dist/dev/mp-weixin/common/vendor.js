...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"Study-app","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 32:
/*!******************************************!*\
  !*** E:/study/Study-app/libs/bmap-wx.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
        ...
        wx.request({
          ...
          success: function success(data) {
            ...
            if (res["status"] === 0) {
              ...
              for (var i = 0; i < poiArr.length; i++) {var _outputRes$wxMarkerDa;
                outputRes["wxMarkerData"][i] = (_outputRes$wxMarkerDa = {
                  id: i,
                  ...
                  iconTapPath: otherparam["iconTapPath"] }, _defineProperty(_outputRes$wxMarkerDa, "title",
                otherparam["title"]), _defineProperty(_outputRes$wxMarkerDa, "address",
                poiArr[i]["address"]), _defineProperty(_outputRes$wxMarkerDa, "telephone",
                poiArr[i]["telephone"]), _defineProperty(_outputRes$wxMarkerDa, "alpha",
                otherparam["alpha"]), _defineProperty(_outputRes$wxMarkerDa, "width",
                otherparam["width"]), _defineProperty(_outputRes$wxMarkerDa, "height",
                otherparam["height"]), _defineProperty(_outputRes$wxMarkerDa, "callout",
                {
                  display: 'ALWAYS', // 常显气泡
                  content: poiArr[i]["name"], //名称文本
                  color: '#fff', //文本颜色
                  borderRadius: 5, //边框圆角
                  borderWidth: 1, //边框宽度
